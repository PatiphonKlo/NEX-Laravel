<button type="button" id="update-product-button-<?php echo e($key); ?>" onclick="updateProductButton<?php echo e($key); ?>()"
        ...
        <div id="overlay-update-product-<?php echo e($key); ?>"
            ...
            <div
                ...
                <form class="p-3 pr-8 overflow-y-auto h-[70vh]"
                    action="<?php echo e(config('app.env') == 'production' ? secure_url('admin/update-product/' . $product['product_id']) : url('admin/update-product/' . $product['product_id'])); ?>"
                    ...
                    <div class="grid gap-4 md:grid-cols-4 mb-4">
                        <div class="col-span-2">
                            ...
                            <input accept=".pdf"
                                ...
                                name="spec_sheet_update<?php echo e($key); ?>" type="file" onchange="validateFileSize(this, '<?php echo e($key); ?>')">
                            <p id="file-size-error<?php echo e($key); ?>" class="mt-2 text-sm text-danger-normal whitespace-normal"
                                style="display:none;">File must not exceed 2MB</p>
                            <?php $__errorArgs = ['spec_sheet_update' . $key];
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-span-2">
                            <label for="product_name_update<?php echo e($key); ?>"
                                class="block mb-2 text-sm font-medium text-gray-900">
                                Product Name</label>
                            <input type="text"
                                value="<?php echo e(old('product_name_update' . $key) ?? $product['product_name'] ?? ''); ?>"
                                name="product_name_update<?php echo e($key); ?>"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="grid gap-4 mb-4 md:grid-cols-2 lg:grid-cols-4">
                        <div>
                            <label for="product_group_update<?php echo e($key); ?>"
                                class="block mb-2 text-sm font-medium text-gray-900">Group
                                Select</label>
                            <select name="product_group_update<?php echo e($key); ?>"
                                ...
                                <option value="<?php echo e($product['product_group'] ?? old('product_group_update' . $key)); ?>"
                                    selected><?php echo e($product['product_group'] ?? old('product_group_update' . $key)); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            <label for="product_model_update<?php echo e($key); ?>"
                                class="block mb-2 text-sm font-medium text-gray-900">Model</label>
                            <input type="hidden" value="<?php echo e($product['product_model']); ?>"
                                name="product_model_update<?php echo e($key); ?>">
                            <div
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-span-1">
                            <label class="block mb-2 text-sm font-medium text-gray-900">Assembly
                                Part Select</label>
                            <button data-dropdown-toggle="dropdown<?php echo e($product['product_model']); ?>update"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <!-- Dropdown menu -->
                        <div id="dropdown<?php echo e($product['product_model']); ?>update"
                            ...
                            <ul id="assemblyUL-<?php echo e($key); ?>"
                                ...
                                <li>
                                    <div class="flex items-center p-2 rounded hover:bg-gray-100">
                                        ...
                                        <input id="checkbox-item-<?php echo e($item['part_id']); ?>" type="checkbox"
                                            name="assembly_part_update<?php echo e($key); ?>[]" value="<?php echo e($item['part_id']); ?>"
                                        ...
                                        <input id="checkbox-item-<?php echo e($item['part_id']); ?>" type="checkbox"
                                            name="assembly_part_update<?php echo e($key); ?>[]" value="<?php echo e($item['part_id']); ?>"
                                            class="w-4 h-4 text-primary bg-gray-100 border-gray-300 rounded focus:ring-primary"
                                            <?php echo e(old('assembly_part_update' . $key) ? (in_array($item['part_id'],
                                ...
                                <li><a href="<?php echo e(url('/admin/assembly-part')); ?>"
                        ...
                        <div class="col-span-1">
                            <label class="block mb-2 text-sm font-medium text-gray-900">Technical
                                Data Select</label>
                            <button data-dropdown-toggle="dropdown<?php echo e($product['product_model']); ?>-update2"
                                class="inline-flex items-center bg-gray-800 border border-gray-300 text-white text-sm rounded-lg focus:ring-primary focus:border-primary w-full p-2.5 hover:bg-gray-400"
                                type="button">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <!-- Dropdown menu -->
                        <div id="dropdown<?php echo e($product['product_model']); ?>-update2"
                            class="z-10 hidden bg-gray-200 rounded-lg shadow w-80">
                            <div class="p-3">
                                <label class="sr-only">Search</label>
                                <div class="relative">
                            ...
                            <ul id="technicalUL-<?php echo e($key); ?>"
                                ...
                                <li>
                                    <div class="flex items-center p-2 rounded hover:bg-gray-100">
                                        ...
                                        <input id="checkbox-item-<?php echo e($item[1]); ?>2" type="checkbox"
                                            name="technical_data_update<?php echo e($key); ?>[]" value="<?php echo e($item[1]); ?>"
                                            class="w-4 h-4 text-primary bg-gray-100 border-gray-300 rounded focus:ring-primary"
                                            checked>
                                        ...
                                        <input id="checkbox-item-<?php echo e($item[1]); ?>2" type="checkbox"
                                            name="technical_data_update<?php echo e($key); ?>[]" value="<?php echo e($item[1]); ?>"
                                            class="w-4 h-4 text-primary bg-gray-100 border-gray-300 rounded focus:ring-primary"
                                            <?php echo e(old('technical_data_update' . $key) ? (in_array($item[1],
                                ...
                                <?php else: ?>
                                <li class="text-center"> No data avliable</li>
                                <li><a href="<?php echo e(url('/admin/technical-data')); ?>"
                                        class="flex justify-center text-primary underline font-medium">Create new
                                        data</a></li>
                                <?php endif; ?>
                            </ul>
                    ...
                    <div class="grid gap-4 mb-4 sm:grid-cols-4 lg:grid-cols-8">
                        ...
                        <div>
                            ...
                            <input type="number"
                                value="<?php echo e(old('product_price_validity_update' . $key) ?? $product['product_price_validity'] ?? ''); ?>"
                                name="product_price_validity_update<?php echo e($key); ?>" id="product_price_validity_update"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="number"
                                value="<?php echo e(old('product_delivery_term_update' . $key) ?? $product['product_delivery_term'] ?? ''); ?>"
                                name="product_delivery_term_update<?php echo e($key); ?>" id="product_delivery_term_update"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary focus:border-primary block w-full p-2.5"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            <label for="product_credit_day_update"
                                ...
                                Days</label>
                            <input type="number"
                                value="<?php echo e(old('product_credit_day_update' . $key) ?? $product['product_credit_day'] ?? ''); ?>"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            <label for="product_discount_update"
                                ...
                                (%)</label>
                            <input type="number"
                                value="<?php echo e(old('product_discount_update' . $key) ?? $product['product_discount'] ?? ''); ?>"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-span-3">
                            <label for="product_price_update" class="block mb-2 text-sm font-medium text-gray-900">Price
                                (THB)</label>
                            <input type="number"
                                value="<?php echo e(old('product_price_update' . $key) ?? $product['product_price'] ?? ''); ?>"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-span-1">
                            <label for="product_warranty_update<?php echo e($key); ?>"
                                class="block mb-2 text-sm font-medium text-gray-900">Warranty
                                (Year)</label>
                            <input type="number"
                                value="<?php echo e(old('product_warranty_update' . $key) ?? $product['product_warranty'] ?? ''); ?>"
                                name="product_warranty_update<?php echo e($key); ?>" id="product_warranty_update"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary focus:border-primary block w-full p-2.5"
                                placeholder="e.g. 1">
                            <?php $__errorArgs = ['product_warranty_update' . $key];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                    ...
                    <div class="grid gap-4 mb-4 sm:grid-cols-3 lg:grid-cols-6">
                        <div class="col-span-1">
                            <label for="product_down_payment_update<?php echo e($key); ?>"
                                ...
                                Payment (%)</label>
                            <input type="number"
                                value="<?php echo e(old('product_down_payment_update' . $key) ?? $product['product_down_payment'] ?? ''); ?>"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-span-1">
                            <label for="product_after_install_update<?php echo e($key); ?>"
                                ...
                                Install (%)</label>
                            <input type="number"
                                value="<?php echo e(old('product_after_install_update' . $key) ?? $product['product_after_install'] ?? ''); ?>"
                                name="product_after_install_update<?php echo e($key); ?>" id="product_after_install_update"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary focus:border-primary block w-full p-2.5"
                                placeholder="e.g. 40">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-span-1">
                            <label for="product_final_check_update<?php echo e($key); ?>"
                                ...
                                Check (%)</label>
                            <input type="number"
                                value="<?php echo e(old('product_final_check_update' . $key) ?? $product['product_final_check'] ?? ''); ?>"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-span-1">
                            <label for="product_logistic_cost_update<?php echo e($key); ?>"
                                class="block mb-2 text-sm font-medium text-gray-900">
                                Logistic & Training (THB)
                            </label>
                            <input type="number"
                                value="<?php echo e(old('product_logistic_cost_update' . $key) ?? $product['product_logistic_cost'] ?? ''); ?>"
                                name="product_logistic_cost_update<?php echo e($key); ?>" id="product_logistic_cost_update"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary focus:border-primary block w-full p-2.5"
                                placeholder="e.g. 3500">
                            <?php $__errorArgs = ['product_logistic_cost_update' . $key];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="grid gap-4 mb-4 md:grid-cols-2 lg:grid-cols-4">
                        <div>
                            ...
                            <input accept=".jpg"
                                class="block w-full text-xs text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 focus:outline-none"
                                name="product_picture_update<?php echo e($key); ?>" type="file" value="">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input accept=".jpg"
                                class="block w-full text-xs text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 focus:outline-none"
                                name="product_front_view_update<?php echo e($key); ?>" type="file">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input accept=".jpg"
                                class="block w-full text-xs text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 focus:outline-none"
                                name="product_side_view_update<?php echo e($key); ?>" type="file">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input accept=".jpg"
                                class="block w-full text-xs text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 focus:outline-none"
                                name="product_top_view_update<?php echo e($key); ?>" type="file">
...
<?php endif; ?><?php /**PATH C:\Users\patip\NEX\miscibles-platform-2.4\src\resources\views/pages/admin/product/modal-update.blade.php ENDPATH**/ ?>