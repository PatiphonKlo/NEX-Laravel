...
@font-face {
    ...
    font-style: italic;
    font-weight: bold;
    src: url("<?php echo e(asset('fonts/THSarabunNew BoldItalic.ttf')); ?>")
        format("truetype");
}
</style>
<body>
    ...
    <thead>
        ...
        <tr>
            <th colspan="12" class="bg-grey">
                <input type="text" class="justify-center" value="221/24 Panyaintra Bangchan Klongsamwa Bangkok 10510 / Tel: 02-548-0414-5 / Fax : 02-548-0413">
                <input type="text" class="justify-center" value="" placeholder="Email : miscible@miscible.co.th / miscibleagitator@gmail.com / www.miscible.co.th">
                <p></p>
            </th>
        </tr>
        <tr>
...
<?php /**PATH C:\my-project\miscibles-platform-development\src\resources\views/CONTENT_MANAGEMENT_SYSTEM/layout/pdfQuotation.blade.php ENDPATH**/ ?>