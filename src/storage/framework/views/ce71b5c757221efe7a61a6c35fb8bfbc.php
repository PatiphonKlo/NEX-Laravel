...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="my-2">
                    <div>
                        <label class="inline-flex items-center ml-6">
                            <input type="radio" id="have_drawing" name="drawing_file" value="yes" <?php echo e(old('drawing_file', $enquiryData['drawing_file']) == 'yes' ? 'checked' : ''); ?> onclick="fileInput()" class="text-primary focus:ring-white">
                            <span class="ml-2">Have</span>
                        </label>
                    </div>
                    <div>
                        <label class="inline-flex items-center ml-6">
                            <input type="radio" id="no_drawing" name="drawing_file" value="no" <?php echo e(old('drawing_file', $enquiryData['drawing_file']) == 'no' ? 'checked' : ''); ?> onclick="fileInput()" class="text-primary focus:ring-white">
                ...
                <div id="upload_drawing_file" onclick="fileInput()" class="hidden w-[90%] ml-6 text-gray-600">
                    ...
                    <p class="mt-1 text-sm text-gray-500" id="file_info">uploaded file: <?php echo e($enquiryData['drawing_file_name'] ?? 'none'); ?></p>
                </div>
...
<?php echo $__env->make('layouts/admin', ['title' => 'Enquiry Form'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\patip\NEX\miscibles-platform\src\resources\views/pages/admin/enquiry/edit.blade.php ENDPATH**/ ?>