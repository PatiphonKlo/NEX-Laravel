...
<table id="part-table" class="min-w-full shadow-md">
    ...
    <tbody id="part-table-body" class="bg-white divide-y divide-gray-200">
        ...
        <tr class="hover:bg-gray-100 ">
            ...
            <?php if(isset($part['spare_part']) && $part['spare_part'] !== '' ): ?>
            <td class="p-4 text-sm font-medium text-gray-900 whitespace-nowrap">
                <?php echo e($part['spare_part']); ?>
...
<?php echo $__env->make('layouts/admin', ['title' => 'Assembly Part CMS'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\patip\NEX\miscibles-platform\src\resources\views/pages/admin/assembly-part/cms.blade.php ENDPATH**/ ?>