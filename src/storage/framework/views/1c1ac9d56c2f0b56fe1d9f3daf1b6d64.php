...
<table id="client-table" class="min-w-full shadow-md">
    ...
    <tbody class="bg-white divide-y divide-gray-200">
        ...
        <tr class="hover:bg-gray-100 ">
            ...
            <?php if(isset($client['client_contact_name']) && $client['client_contact_name'] !== '' &&
            $client['client_id'] !== ''): ?>
...
<?php echo $__env->make('layouts/admin',['title' => 'Client Data CMS'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\my-project\miscibles-platform\src\resources\views/pages/admin/client/cms.blade.php ENDPATH**/ ?>