        ...
        <div class="flex items-center justify-center flex-nowrap">
            <div class="inline">
                <p class="font-normal text-left ml-3 text-white cookie-consent__message">
                    <?php echo trans('cookie-consent::texts.message'); ?> <a class="underline cursor-pointer break-words" href="https://pdpa.pro/policies/view/th/W8KUPWQf5kPgft1rgbJdy4kE">อ่านนโยบายเพิ่มเติม</a>
                    <?php echo $__env->make('MADE_TO_ORDER/component/policy', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </p>
            </div>
...
<?php /**PATH C:\miscibles-platform\src\vendor\spatie\laravel-cookie-consent\src\/../resources/views/dialogContents.blade.php ENDPATH**/ ?>