    ...
    <div class="lg:grid lg:min-h-screen lg:grid-cols-12">
        ...
        <main class="flex items-center justify-center px-8 py-8 sm:px-12 lg:col-span-7 lg:px-16 lg:py-12 xl:col-span-6">
            <div class="max-w-xl lg:max-w-3xl flex flex-col items-center justify-center">
                ...
                <form action="<?php echo e(config('app.env') == 'production' ? secure_url('pdf-access/'.$type .'/'.$key) : url('pdf-access/'.$type .'/'.$key)); ?>" method="post" class="flex flex-col gap-4 items-center justify-center">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts/blank', ['title' => 'PDF Access'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\my-project\miscibles-platform\src\resources\views/pages/authentication/pdf-access.blade.php ENDPATH**/ ?>