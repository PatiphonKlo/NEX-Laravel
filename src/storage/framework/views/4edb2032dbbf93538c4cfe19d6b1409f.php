...
<?php $component->withAttributes(['action' => ''.e(config('app.env') == 'production' ? secure_url('authentication/login') : url('authentication/login')).'','method' => 'POST']); ?>
                <div class="mb-4">
                    ...
                    <input name="email" class="bg-gray-50 border border-gray-500 focus:ring-bg-primary focus:border-bg-primary rounded-lg w-full py-3 px-3 text-black" id="email" type="email" placeholder="Enter your email address" required />
                </div>
                <div class="mb-4">
                    <label class="block font-semibold text-black mb-2" for="password">
                        Password
                    </label>
                    <input name="password" class="bg-gray-50 border border-gray-500 focus:ring-bg-primary focus:border-bg-primary rounded-lg w-full py-3 px-3 text-black mb-3" id="password" type="password" placeholder="Enter your password" required />
                </div>
                <div class="mb-5">
                    <button type="submit" class="uppercase w-full bg-primary hover:bg-green-900 text-white font-bold py-2 px-4 rounded-lg">
                        Login
                    </button>
                </div>
...
<?php endif; ?>
            <a href="<?php echo e(url('standard-product')); ?>">
                <button class="uppercase text-center w-full bg-primary hover:bg-green-900 text-white font-bold py-2 px-4 rounded-lg">
...
<?php echo $__env->make('layouts/blank',['title' => 'Authentication'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\miscibles-platform\src\resources\views/pages/authentication/login.blade.php ENDPATH**/ ?>