                                        ...
                                        <li>
                                            <div class="flex items-center p-2 rounded hover:bg-gray-100">
                                                <input id="checkbox-item-<?php echo e($item['part_id']); ?>" type="checkbox"
                                                    ...
                                                    <?php echo e(old('assembly_part') ? (in_array($item['part_id'], old('assembly_part')) ? 'checked' : '') : ''); ?>>
                            ...
                            <ul id="technicalUL"
                                ...
                                <?php if(!empty($technicalData)): ?>
                                    <?php $__currentLoopData = $technicalData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li>
                                            <div class="flex items-center p-2 rounded hover:bg-gray-100">
                                                <input id="checkbox-item-<?php echo e($item[1]); ?>" type="checkbox"
                                                    name="technical_data[]" value="<?php echo e($item[1]); ?>"
                                                    class="w-4 h-4 text-primary bg-gray-100 border-gray-300 rounded focus:ring-primary"
                                                    <?php echo e(old('technical_data') ? (in_array($item[1], old('technical_data')) ? 'checked' : '') : ''); ?>>
        ...
        if (input.files) {
            ...
            img.onload = function() {
                ...
                if (this.width > maxWidth || this.height > maxHeight) {
                    ...
                    error.innerHTML = `Image aspect ratio is incorrect. Expected: ${desiredAspectRatio === 3 / 4 ? '3:4' : '4:3'}`;
                    resetInput(input);
                    return false;
                }
...
<?php endif; ?>
<?php /**PATH C:\NEX\miscibles-platform-2.1\src\resources\views/pages/admin/product/modal-add.blade.php ENDPATH**/ ?>