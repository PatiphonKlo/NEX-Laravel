...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.go-back-button','data' => ['class' => 'uppercase w-full bg-primary hover:bg-green-900 text-white font-bold py-2 px-4 rounded-lg']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'uppercase w-full bg-primary hover:bg-green-900 text-white font-bold py-2 px-4 rounded-lg']); ?>
                    back
                 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php echo $__env->make('layouts/blank', ['title' => 'Authentication'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\patip\NEX\miscibles-platform-2.4\src\resources\views/pages/authentication/login.blade.php ENDPATH**/ ?>