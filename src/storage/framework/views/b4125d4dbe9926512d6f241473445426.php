<button type="button" id="share-product-button-<?php echo e($key); ?>" onclick="shareProductButton<?php echo e($key); ?>()"
    class="bg-primary hover:bg-green-800 uppercase w-full inline-flex items-center px-3 py-2 text-xs font-medium text-center text-white  rounded-md ">
    <img src="/svg/description.svg" alt="NA" class="w-4 h-4 mr-2">
    SPEC SHEET
</button>
        ...
        <div id="overlay-share-<?php echo e($key); ?>"
            ...
            <div
                ...
                <div class="p-3 pr-8 overflow-y-auto h-[50vh]"
                    action="<?php echo e(config('app.env') == 'production' ? secure_url('admin/share-password/' . $product['product_id']) : url('admin/share-pasword/' . $product['product_id'])); ?>"
...
<?php endif; ?>
                    <div class="relative flex justify-end items-center mb-4">
                        <a data-copy-target='copiedLink<?php echo e($key); ?>'
                            href="<?php echo e(url('pdf-access/spec/' . $product['product_id'])); ?>" target="_blank"
                            ...
                            <?php echo e(url('pdf-access/spec/' . $product['product_id'])); ?>
...
<?php endif; ?>
                    <div class="relative flex justify-end items-center">
                        <input disabled value="<?php echo e($product['spec_password'] ?? ''); ?>" type="text"
                            data-copy-target="copyPassword<?php echo e($key); ?>"
...
<script>
    function shareProductButton<?php echo e($key); ?>() {
...
<?php /**PATH C:\NEX\miscibles-platform-2.1\src\resources\views/pages/admin/product/spec/modal.blade.php ENDPATH**/ ?>