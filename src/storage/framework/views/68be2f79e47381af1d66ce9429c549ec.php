...
'text-sm p-4 rounded-md border-1 border-red-600 w-full':
'text-sm p-4 rounded-md border-none border-gray-300 shadow-sm w-full';
?>


<?php if($errors->has($attributes->get('name'))): ?>
<div class="w-full flex justify-end items-center relative">
    <textarea rows="3" <?php echo e($disabled ? 'disabled':''); ?> <?php echo e($attributes->merge(['class' => $class])); ?>>
...
<?php else: ?>
    <textarea rows="3" <?php echo e($disabled ? 'disabled':''); ?> <?php echo e($attributes->merge(['class' => $class])); ?>></textarea>
<?php $__errorArgs = [$attributes->get('name')];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php endif; ?><?php /**PATH C:\miscibles-platform - Copy\miscibles-platform\src\resources\views/components/text-area-input.blade.php ENDPATH**/ ?>