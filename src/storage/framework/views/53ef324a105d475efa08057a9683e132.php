                    ...
                    <tr class="hover:bg-gray-100 ">
                        ...
                        <td class="p-4 flex flex-col xl:flex-row space-y-2 xl:space-y-0 xl:space-x-2">
                            <div class="w-36 xl:w-32">
                                <?php echo $__env->make('pages/admin/product/spec/modal-share', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            </div>
                            <div class="w-36">
...
<?php echo $__env->make('layouts/admin', ['title' => 'Product CMS'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\patip\NEX\miscibles-platform\src\resources\views/pages/admin/product/cms.blade.php ENDPATH**/ ?>