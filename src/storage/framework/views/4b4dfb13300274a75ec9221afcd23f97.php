...
<div class="grid sm:grid-cols-2 my-5 gap-5 text-xs lg:text-base">
    <div class="border-2 border-green-600 rounded-md shadow shadow-gray-400 lg:pt-1/4 flex flex-col space-y-3 lg:space-y-10 items-center p-4 lg:p-10">
        <div class="flex flex-col lg:grid grid-cols-2 gap-2 lg:gap-10">
...
<?php echo $__env->make('layouts/secondary',[ 'title' => 'Technical Data', 'subtitle' => $model], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\miscibles-platform\src\resources\views/pages/user/technical-data.blade.php ENDPATH**/ ?>