<div class="px-6 py-20 max-w-2xl mx-auto">
    <div class="flex justify-between mb-6">
        <div class="font-bold">
            <div><?php echo e($productData['product_name']); ?> (<?php echo e($productData['product_group']); ?>)</div>
            <div class="font-bold"> <?php echo e($productData['product_model']); ?></div>
        </div>
        <div class=" font-bold">
...
<?php /**PATH C:\NEX\miscibles-platform\src\resources\views/pages/user/components/quotation-preview.blade.php ENDPATH**/ ?>