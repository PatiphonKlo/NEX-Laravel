    ...
    <div class="h-full border-2 border-green-600 rounded-md shadow shadow-gray-400 lg:pt-1/4 flex flex-col items-center p-4 lg:p-10 gap-2">
        <div class="flex flex-col lg:grid grid-cols-2 gap-2">
            <div class="flex justify-center items-center">
                <img src="<?php echo e($imageURL[0]); ?>" class="w-72 h-72" onerror="this.onerror=null; this.src='<?php echo e(asset('images/no-image.png')); ?>'; this.className='w-60 border-2';">
            </div>
            <div class="flex justify-center items-center">
                <img src="<?php echo e($imageURL[1]); ?>" class="w-72 h-72" onerror="this.onerror=null; this.src='<?php echo e(asset('images/no-image.png')); ?>'; this.className='w-60 border-2';">
            </div>
        </div>
        <div class="flex justify-center items-center">
            <img src="<?php echo e($imageURL[1]); ?>" class="w-72 h-72" onerror="this.onerror=null; this.src='<?php echo e(asset('images/no-image.png')); ?>'; this.className='w-60 border-2';">
...
<?php echo $__env->make('layouts/secondary',[ 'title' => 'Technical Data', 'subtitle' => $model], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\patip\NEX\miscibles-platform\src\resources\views/pages/user/technical-data.blade.php ENDPATH**/ ?>