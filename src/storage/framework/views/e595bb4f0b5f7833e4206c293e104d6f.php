<button type="button" id="add-client-button" onclick="addClientButton()" class="text-white bg-primary hover:bg-green-900 focus:ring-2 focus:ring-gray-200 font-medium rounded-md text-sm px-4 py-2.5 max-h-11 focus:outline-none">
    NEW CLIENT
</button>
...
<?php if(!($errors->has('client_contact_name') || $errors->has('energy_used') || $errors->has('spec'))): ?>
<script>
...
<?php if(($errors->has('client_contact_name') || $errors->has('client_phone_number') || $errors->has('client_company')) || $errors->has('client_email')): ?>
<script>
    let add_client_modal = document.getElementById('popup-modal-add-client')
    let add_client_button = document.getElementById('add-client-button')
    let add_client_close_button = document.getElementById('close-modal-button')
...
<?php endif; ?>
<?php /**PATH C:\miscibles-platform\src\resources\views/pages/admin/client/modal-add.blade.php ENDPATH**/ ?>