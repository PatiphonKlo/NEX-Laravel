...
<div class="flex flex-col lg:grid grid-cols-2 pt-[2vh] gap-5">
    ...
    <div class="col-span-1 flex flex-col">
        <div class="shadow shadow-gray-400 border-2 border-green-600 lg:h-[580px] rounded-md flex items-center">
...
<?php echo $__env->make('layouts/secondary',[ 'title' => 'Quotation Request', 'subtitle' => $model], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\my-project\miscibles-platform\src\resources\views/pages/user/quotation-request.blade.php ENDPATH**/ ?>