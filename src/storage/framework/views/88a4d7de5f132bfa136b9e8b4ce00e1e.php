...
<div class="my-2">
    ...
    <div>
        <label class="inline-flex items-center ml-6">
            <input type="radio" id="<?php echo e($option['id']); ?>" name="<?php echo e($name); ?>" value="<?php echo e($option['value']); ?>" class="text-primary focus:ring-white" onclick="toggleOptionalInput('<?php echo e($name); ?>', '<?php echo e($otherInputName); ?>')" <?php echo e(old($name) == $option['value'] ? 'checked' : ''); ?>>
...
<?php /**PATH C:\Users\patip\NEX\miscibles-platform-2.4\src\resources\views/components/radio-input.blade.php ENDPATH**/ ?>