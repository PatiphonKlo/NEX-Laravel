...
<?php $component->withAttributes(['action' => ''.e(config('app.env') == 'production' ? secure_url('client-add/' . $model) : url('client-add/' . $model)).'','method' => 'POST']); ?>
                <?php echo csrf_field(); ?>
                <div
                    class="shadow shadow-gray-400 border-2 border-green-600 h-[60vh] lg:h-[80vh] rounded-md p-16 overflow-y-auto">
...
<?php echo $__env->make('layouts/secondary', ['title' => 'Quotation Request', 'subtitle' => $model], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\miscibles-platform\src\resources\views/pages/user/client-add.blade.php ENDPATH**/ ?>