            ...
            <?php if(isset($quotationData)): ?>
                <?php $__currentLoopData = $quotationData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $quotation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="count hover:bg-gray-100 ">
                        ...
                        <?php if(isset($quotation['quotation_code']) &&
                                $quotation['quotation_code'] !== '' &&
                                isset($quotation['product_data']['product_name']) &&
...
<?php echo $__env->make('layouts/admin', ['title' => 'Quotation CMS'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\miscibles-platform - Copy\miscibles-platform\src\resources\views/pages/admin/quotation/cms.blade.php ENDPATH**/ ?>