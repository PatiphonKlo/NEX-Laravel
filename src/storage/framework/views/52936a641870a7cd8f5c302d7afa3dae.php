...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-span-1">
                            ...
                            <input type="number"
                                value="<?php echo e(old('product_logistic_cost')); ?>"
                                name="product_logistic_cost" id="product_logistic_cost"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary focus:border-primary block w-full p-2.5"
                                placeholder="e.g. 3500">
                            <?php $__errorArgs = ['product_logistic_cost'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\patip\NEX\miscibles-platform\src\resources\views/pages/admin/product/modal-add.blade.php ENDPATH**/ ?>