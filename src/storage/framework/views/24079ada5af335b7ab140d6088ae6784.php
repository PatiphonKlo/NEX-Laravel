<button type="button" id="share-enquiry-button-<?php echo e($key); ?>" onclick="shareEnquiryButton<?php echo e($key); ?>()"
    <?php echo e($enquiry['client_data'] ? '' : 'disabled'); ?>

    class="<?php echo e($enquiry['client_data'] ? 'bg-primary hover:bg-green-800' : 'bg-green-200 cursor-not-allowed'); ?> uppercase w-full inline-flex items-center px-3 py-2 text-xs font-medium text-center text-white  rounded-md ">
        ...
        <div id="overlay-share-<?php echo e($key); ?>"
            ...
            <div
                ...
                <div class="p-3 pr-8 overflow-y-auto h-[50vh]"
                    action="<?php echo e(config('app.env') == 'production' ? secure_url('admin/share-password/' . $enquiry['enquiry_id']) : url('admin/share-pasword/' . $enquiry['enquiry_id'])); ?>"
...
<?php endif; ?>
                    <div class="relative flex justify-end items-center mb-4">
                        <a data-copy-target='copiedLink<?php echo e($key); ?>'
                            href="<?php echo e(url('pdf-access/enquiry/' . $enquiry['enquiry_id'])); ?>" target="_blank"
...
<?php endif; ?>
                    <div class="relative flex justify-end items-center">
                        <input disabled value="<?php echo e($enquiry['enquiry_password'] ?? ''); ?>" type="text"
...
<?php /**PATH C:\Users\patip\NEX\miscibles-platform\src\resources\views/pages/admin/enquiry/modal-share.blade.php ENDPATH**/ ?>