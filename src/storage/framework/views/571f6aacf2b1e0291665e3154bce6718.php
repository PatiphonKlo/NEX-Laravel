    ...
    <?php $__currentLoopData = $chunks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chunk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <table id="quotaionTable">
            ...
            <tbody>
                <?php if($loop->first): ?>
                    ...
                    <tr>
                        ...
                        <td colspan="6" class="dashed-right left">
                            <?php echo e($quotation['product_data']['product_name'] ?? ''); ?>
                ...
                <?php $__currentLoopData = $chunk; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $technical_data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="dashed">
                        <td colspan="1" class="dashed-right"></td>
                        <td colspan="6" class="dashed-right left">
                            <?php echo e($technical_data['technical_component']); ?> :
                            <?php echo e($technical_data['specification']); ?>
            ...
            <tfoot>
                ...
                <tr>
                    ...
                    <th colspan="2" class="bg-dark-grey">
                        <?php echo e(number_format(($quotation['product_price'] ?? 0) + ($quotation['product_data']['product_logistic_cost'] ?? 0))); ?>
                ...
                <tr>
                    ...
                    <th colspan="2" class="bg-dark-grey">
                        <?php echo e(number_format($totalPrice * (($quotation['product_down_payment'] ?? 0) / 100))); ?>

                    </th>
                    <th colspan="2" class="bg-dark-grey">
                        <?php echo e(number_format($totalPrice * (($quotation['product_final_check'] ?? 0) / 100))); ?>

                    </th>
                    <th colspan="2" class="bg-dark-grey">
                        <?php echo e(number_format($totalPrice * (($quotation['product_after_install'] ?? 0) / 100))); ?>
...
<?php /**PATH C:\Users\patip\NEX\miscibles-platform\src\resources\views/layouts/pdf/quotation.blade.php ENDPATH**/ ?>