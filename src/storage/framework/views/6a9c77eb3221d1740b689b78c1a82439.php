<button type="button" id="delete-technical-button-<?php echo e($technical['technical_data_id']); ?>" onclick="deleteTechnicalButton<?php echo e($technical['technical_data_id']); ?>()"
...
<div id="popup-modal-delete-technical-<?php echo e($technical['technical_data_id']); ?>" class="hidden relative z-30" aria-labelledby="modal-title"
            ...
            <div
                ...
                <div class="p-6 text-center">
                    ...
                    <h3 class="mb-5 text-lg font-normal text-gray-500">Are you sure you want to delete
                        ...
                        ID: <?php echo e($technical['technical_data_id']); ?></h3>
                    <a href=" <?php echo e(url('admin/delete-technical/'.$technical['technical_data_id'])); ?>">
                        <button type="button"
...
<script>
    function deleteTechnicalButton<?php echo e($technical['technical_data_id']); ?>(){
        let delete_technical_button = document.getElementById('delete-technical-button-<?php echo e($technical['technical_data_id']); ?>')
        let delete_technical_modal = document.getElementById('popup-modal-delete-technical-<?php echo e($technical['technical_data_id']); ?>')
        let delete_technical_close_button1 = document.getElementById('delete-technical-close-button-1-<?php echo e($technical['technical_data_id']); ?>')
        let delete_technical_close_button2 = document.getElementById('delete-technical-close-button-2-<?php echo e($technical['technical_data_id']); ?>')
...
</script><?php /**PATH C:\my-project\miscibles-platform\src\resources\views/pages/admin/technical-data/modal-delete.blade.php ENDPATH**/ ?>