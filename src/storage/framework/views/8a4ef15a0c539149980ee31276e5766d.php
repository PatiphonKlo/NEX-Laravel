...
<?php $__env->startSection('content'); ?>
    <div class="flex flex-col lg:grid grid-cols-2 pt-[2vh] gap-5">
        ...
        <div class="col-span-1 flex flex-col">
            ...
            <table>
                <tr><td class="pr-5 font-medium">Name</td> <td>: <?php echo e($customerData['CONTACT_NAME']); ?></td></tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('STANDARD_PRODUCTS/layout/defaultLayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\my-project\miscibles-platform\src\resources\views/STANDARD_PRODUCTS/page/before_order_confirm.blade.php ENDPATH**/ ?>