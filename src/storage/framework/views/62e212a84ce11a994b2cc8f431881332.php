...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.go-back-button','data' => ['class' => 'bg-gray-400 uppercase text-white px-4 py-2 rounded-md font-semibold']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'bg-gray-400 uppercase text-white px-4 py-2 rounded-md font-semibold']); ?>Back <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="my-2">
                        <div>
                            <label class="inline-flex items-center ml-6">
                                <input type="radio" id="have_drawing" name="drawing_file" value="yes"
                                    <?php echo e(old('drawing_file') == 'yes' ? 'checked' : ''); ?> onclick="fileInput()"
                        ...
                        <div>
                            <label class="inline-flex items-center ml-6">
                                <input type="radio" id="no_drawing" name="drawing_file" value="no"
                                    <?php echo e(old('drawing_file') == 'no' ? 'checked' : ''); ?> onclick="fileInput()"
                                    class="text-primary focus:ring-white">
                        ...
                        <div>
                            <label class="inline-flex items-center ml-6">
                                <input type="radio" id="otherCheck" name="drawing_file" value="others"
                                    <?php echo e(old('drawing_file') == 'others' ? 'checked' : ''); ?> onclick="fileInput()"
                                    class="text-primary focus:ring-white">
...
<?php echo $__env->make('layouts/admin', ['title' => 'Enquiry Form'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\my-project\miscibles-platform\src\resources\views/pages/admin/enquiry/add.blade.php ENDPATH**/ ?>