...
<h1 class="ml-5 text-xl font-semibold text-gray-900 sm:text-2xl uppercase">Quotation: <?php echo e($quotationData['quotation_code']); ?></h1>
<div class="flex flex-col m-5">
    <form action="<?php echo e(config('app.env') == 'production' ? secure_url('admin/pdf-quotation') : url('admin/pdf-quotation')); ?>" method="GET">
        ...
        <input type="hidden" value="<?php echo e($quotationData['quotation_id']); ?>" name="quotation_id">
        <input id="inputLayoutKey" type="hidden" onchange="quotationLayout()" name="quotation_layout_name">
    ...
    <form action="<?php echo e(config('app.env') == 'production' ? secure_url('admin/update_quotation_layout') : url('admin/update_quotation_layout')); ?>" method="POST">
        ...
        <div class="flex gap-4 mb-4">
            <select id="quotationSelector" onChange="changeQuotation()" class="rounded-md w-[250px] focus:outline-none shadow-none">
                ...
                <option value="<?php echo e($key); ?>">Layout: <?php echo e($item['quotation_layout_name']); ?></option>
...
<?php endif; ?>
        ...
        <div class="min-w-[210mm] min-h-[297mm] mr-6">
            ...
            <?php else: ?>
            <?php echo $__env->make('layouts/pdf/quotation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php endif; ?>
        </div>
    </form>
</div>
...
<script>
    ...
    function changeQuotation() {
        ...
        quotationLayout.setAttribute("value", documentData[selectorValue]['quotation_id']);
...
<?php echo $__env->make('layouts/admin'['title' => 'Quotation Editor'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\my-project\miscibles-platform\src\resources\views/pages/admin/quotation/quotation-view.blade.php ENDPATH**/ ?>