        ...
        <div class="flex flex-row gap-x-4">
            <div class="items-center mb-0">
                <div class="relative w-48 lg:w-64 xl:w-96 flex justify-end items-center">
                    <input type="text" onkeyup="quotationSearch()" id="quotation-search" class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-600 focus:border-green-600 p-2.5" placeholder="Quotation Search">
...
<table id="quotation-table" class="min-w-full shadow-md">
    <thead class="bg-gray-100 sticky top-0">
        <tr>
            <th scope="col" class="p-4 text-xs font-medium text-left text-black uppercase">
                Product
                <p class="text-xxs font-normal">Quotation ID</p>
            </th>
            <th scope="col" class="p-4 text-xs font-medium text-left text-black uppercase">
                CLIENT <br>
    ...
    <tbody id="quotation-table-body" class="bg-white divide-y divide-gray-200">
        ...
        <tr class="hover:bg-gray-100 ">
            ...
            <?php if(isset($quotation['KEY']) && $quotation['KEY'] !== ''): ?>
            <td class="p-4 text-sm font-medium text-gray-900 whitespace-nowrap">
                <?php echo e($quotation['PRODUCT']['MODEL']); ?> <br>
                <p class="text-xxs font-normal"><?php echo e($quotation['KEY']); ?></p>
            </td>
            <?php else: ?>
            <td class="p-4 text-xs font-normal text-red-600 whitespace-nowrap">Data Not Found</td>
            <?php endif; ?>

            <?php if(isset($quotation['CLIENT']['CONTACT_NAME']) && $quotation['CLIENT']['CONTACT_NAME'] !== '' && isset($quotation['CREATED_AT']) &&
            $quotation['CREATED_AT'] !== ''): ?>
            <td class="p-4 text-sm font-medium text-gray-900 whitespace-nowrap">
                <?php echo e($quotation['CLIENT']['CONTACT_NAME']); ?> <br>
            ...
            <?php if(isset($quotation['EDITED_BY']) && $quotation['EDITED_BY'] !== '' && isset($quotation['EDITED_AT']) &&
            $quotation['EDITED_AT'] !== ''): ?>
            <td class="p-4 text-sm font-medium text-gray-900 whitespace-nowrap">
            ...
            <td class="p-4 flex space-x-2">
                ...
                <div class="w-24">
                    <?php echo $__env->make('CONTENT_MANAGEMENT_SYSTEM/component/quotationDeleteModal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
            </td>
        </tr>
...
<script>
    function quotationSearch() {
        ...
        input = document.getElementById('quotation-search')
...
<script>
    ...
    document.getElementById('quotation-search').addEventListener('keyup', countAndDisplayVisibleRows);
...
<?php echo $__env->make('CONTENT_MANAGEMENT_SYSTEM/layout/defaultLayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\my-project\miscibles-platform-development\src\resources\views/CONTENT_MANAGEMENT_SYSTEM/page/quotations.blade.php ENDPATH**/ ?>