        ...
        <tbody>
            <tr>
                ...
                <td colspan="2" class="dashed-right">
                    <?php echo e(number_format($quotation['product_data']['product_price'] ?? 0)); ?></td>
                <td colspan="2" class="dashed-right">
                    <?php echo e(number_format($quotation['product_data']['product_price'] ?? 0)); ?></td>
            </tr>
        ...
        <tfoot>
            ...
            <tr>
                <th colspan="4" class="bg-grey">Price Validity:
                    (<?php echo e($quotation['product_data']['product_price_validity'] ?? ''); ?> Days)</th>
                <th colspan="4" class="bg-grey">Delivery Term :
                    (<?php echo e($quotation['product_data']['product_delivery_term'] ?? ''); ?> Days)</th>
                <th colspan="2" class="bg-grey">DISCOUNT</th>
                <th colspan="2">
                    <?php echo e(number_format($quotation['product_data']['product_discount'] ?? 0, 1, '.', '')); ?> %</th>
            </tr>
            <tr>
                ...
                <th colspan="2" class="bg-grey" rowspan="3">Credit
                    <?php echo e($quotation['product_data']['product_credit_day'] ?? ''); ?> Days</th>
                <th colspan="2" class="bg-grey">TOTAL</th>
                <th colspan="2" class="bg-dark-grey">
                    <?php echo e(number_format($quotation['product_data']['product_price'] ?? 0)); ?></th>
            </tr>
            <tr>
                <th colspan="2" class="bg-grey">
                    <?php echo e(number_format($quotation['product_data']['product_down_payment'] ?? 0, 1, '.', '')); ?>%</th>
                <th colspan="2" class="bg-grey">
                    <?php echo e(number_format($quotation['product_data']['product_final_check'] ?? 0, 1, '.', '')); ?>%</th>
                <th colspan="2" class="bg-grey">
                    <?php echo e(number_format($quotation['product_data']['product_after_install'] ?? 0, 1, '.', '')); ?>%</th>
                <th colspan="2" class="bg-grey">VAT 7.0%</th>
                <th colspan="2" class="bg-dark-grey">
                    <?php echo e(number_format(($quotation['product_data']['product_price'] ?? 0) * 0.07)); ?></th>
            </tr>
            <tr>
                <th colspan="2" class="bg-dark-grey">
                    <?php echo e(number_format((($quotation['product_data']['product_price'] ?? 0) + ($quotation['product_data']['product_price'] ?? 0) * 0.07) * (($quotation['product_data']['product_down_payment'] ?? 0) / 100))); ?>

                </th>
                <th colspan="2" class="bg-dark-grey">
                    <?php echo e(number_format((($quotation['product_data']['product_price'] ?? 0) + ($quotation['product_data']['product_price'] ?? 0) * 0.07) * (($quotation['product_data']['product_final_check'] ?? 0) / 100))); ?>

                </th>
                <th colspan="2" class="bg-dark-grey">
                    <?php echo e(number_format((($quotation['product_data']['product_price'] ?? 0) + ($quotation['product_data']['product_price'] ?? 0) * 0.07) * (($quotation['product_data']['product_after_install'] ?? 0) / 100))); ?>

                </th>
                <th colspan="2" class="bg-grey">TOTAL PRICE</th>
                <th colspan="2" class="bg-dark-grey">
                    <?php echo e(number_format(($quotation['product_data']['product_price'] ?? 0) + ($quotation['product_data']['product_price'] ?? 0) * 0.07 - (($quotation['product_data']['product_price'] ?? 0) * ($quotation['product_data']['product_discount'] ?? 0)) / 100)); ?>
...
<?php /**PATH C:\my-project\miscibles-platform\src\resources\views/layouts/pdf/quotation.blade.php ENDPATH**/ ?>