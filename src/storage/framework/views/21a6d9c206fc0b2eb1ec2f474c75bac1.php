...
<div id="status-alert-server-side" class="relative z-40">
    ...
    <div class="fixed inset-0 top-5 z-10 w-screen">
        <div class="flex min-h-full justify-center p-4 text-center items-start sm:p-0">
            <div class="p-5 relative transform rounded-lg shadow-xl transition-all w-full sm:max-w-xl md:max-w-2xl lg:max-w-4xl border-t-4 flex items-center <?php echo e(session('error') ? 'text-red-800  border-red-800 bg-red-50' : 'text-green-800 border-green-800 bg-green-50'); ?>">
...
<?php endif; ?>
<?php /**PATH C:\miscibles-platform - Copy\miscibles-platform\src\resources\views/layouts/shared/status-alert-server-side.blade.php ENDPATH**/ ?>