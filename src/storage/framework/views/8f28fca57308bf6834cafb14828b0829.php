        ...
        <?php for($i=0;$i<=10;$i++): ?> <tr>
            ...
            <tr class="dashed">
                ...
                <td colspan="9" class="dashed-right">
                    <input id="annotation" style="width: 75%;" id="content6" name="content6" type="text"><input id="annotation" style="width: 8%;" id="content7" name="content7" type="text">
                </td>
                <td colspan="2" class="dashed-right"></td>
            </tr>
    </tbody>
...
<?php /**PATH C:\my-project\miscibles-platform-development\src\resources\views/components/quotation.blade.php ENDPATH**/ ?>