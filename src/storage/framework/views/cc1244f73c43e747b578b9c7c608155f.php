...
<?php endif; ?>
        ...
        <!-- Logo(normal screen) -->
        <div href="<?php echo e(url('/')); ?>" class="hidden lg:flex col-start-11 col-span-2 justify-end items-center">
            <img src="/svg/NEX-logo.svg" alt="NEX logo" class="h-12 w-full" />
        </div>

    </div>
</nav><?php /**PATH C:\Users\patip\NEX\miscibles-platform-2.4\src\resources\views/layouts/shared/topbar-2.blade.php ENDPATH**/ ?>