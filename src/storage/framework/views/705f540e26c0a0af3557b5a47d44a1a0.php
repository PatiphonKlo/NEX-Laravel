...
<div id="popup-modal-update-part-<?php echo e($key); ?>" class="hidden relative z-30" aria-labelledby="modal-title" role="dialog"
    aria-modal="true">
    ...
    <div class="fixed inset-0 z-10 w-screen">
        <div id="overlay-update-part-<?php echo e($key); ?>"
            ...
            <div
                ...
                <!-- Modal body -->
                <form class="p-3 pr-8 overflow-y-auto h-[40vh]" action="<?php echo e(config('app.env') == 'production' ? secure_url('admin/update-part/' . $key) : url('admin/update-part/' . $key)); ?>"
                    ...
                    <div class="grid gap-4 mb-4 sm:grid-cols-4">
                        <div class="col-span-2">
                            <label for="part_name" class="block mb-2 text-sm font-medium text-gray-900">Assembly Part
                                Name</label>
                            <input disabled type="text" value="<?php echo e($part['part_name']); ?>"
                        ...
                        <div>
                            ...
                            <div
                                ...
                                <input type="text" value="<?php echo e($part['part_id']); ?>" name="part_id" 
                        ...
                        <div>
                            <label for="spare_part" class="block mb-2 text-sm font-medium text-gray-900">Spare
                                part</label>
                            <input disabled type="number" value="<?php echo e($part['spare_part']); ?>"
                                class="bg-gray-50 border border-gray-300 text-gray-400 text-sm rounded-lg focus:ring-primary focus:border-primary block w-full p-2.5"
                                placeholder="ex. 5">
                        </div>
                    </div>
                    <div class="grid gap-4 mb-4 md:grid-cols-2 lg:grid-cols-4">
                        <div class="col-span-4">
                            <label for="part_price_update<?php echo e($key); ?>" class="block mb-2 text-sm font-medium text-gray-900">Cost
                                (Baht)</label>
                            <input type="number" value="<?php echo e(old('part_price_update'.$key) ?? $part['part_price']); ?>" name="part_price_update<?php echo e($key); ?>"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary focus:border-primary block w-full p-2.5"
                                placeholder="Price / Cost">
                            <?php $__errorArgs = ['part_price_update' . $key];
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <input name="update_key" id="key" type="hidden" value="<?php echo e($key); ?>">
...
<?php if($errors->has('part_price_update' . $key)): ?>
<script>
    window.onload = function() {
        updatePartButton<?php echo e($key); ?>();
    };
</script>
<?php endif; ?><?php /**PATH C:\Users\patip\NEX\miscibles-platform\src\resources\views/pages/admin/assembly-part/modal-update.blade.php ENDPATH**/ ?>