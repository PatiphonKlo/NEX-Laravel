            ...
            <?php if(isset($quotationData)): ?>
                <?php $__currentLoopData = $quotationData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $quotation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="count hover:bg-gray-100 ">
                        ...
                        <?php if((isset($quotation['quotation_code']) && $quotation['quotation_code'] !== '') || (isset($quotation['product_data']['product_name']) && $quotation['product_data']['product_name'] !== '')): ?>
                        ...
                        <td class="p-4 flex space-x-2">
                            <div class="w-24">
                                <?php echo $__env->make('pages/admin/quotation/modal-view', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            </div>
                            <div class="w-24">
...
<?php echo $__env->make('layouts/admin', ['title' => 'Quotation CMS'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\NEX\miscibles-platform-2.1\src\resources\views/pages/admin/quotation/cms.blade.php ENDPATH**/ ?>