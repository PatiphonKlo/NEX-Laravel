    ...
    <div class="flex flex-col lg:grid grid-cols-2 pt-[2vh] gap-5">
        ...
        <div class="col-span-1 flex flex-col">
            ...
            <div class="grid grid-cols-3 gap-2 mt-[2vh]">
                ...
                <a href="<?php echo e(url('client-edit-form/' . $model . '/' . $postKey)); ?>" class="col-start-2 col-span-1">
                    <div
                        class="p-2 uppercase border-2 border-gray-normal bg-secondary transition hover:bg-gray-normal hover:text-white rounded-md text-center">
                        edit
                    </div>
                </a>
                ...
                <button class="col-start-3 col-span-1" data-modal-target="popup-modal" data-modal-toggle="popup-modal">
                    <div
                        class="p-2 uppercase border-2 border-green-500 bg-green-400 transition hover:bg-green-500 hover:text-white rounded-md text-center">
                        request quotation
                    </div>
                </button>
                        ...
                        <div class="relative bg-white rounded-lg shadow">
                            ...
                            <div class="p-6 text-center">
                                ...
                                <div class="flex gap-4 justify-center">
                                    <a href="<?php echo e(url('admin/request-quotation/' . $model . '/' . $postKey)); ?>">
                                        <button type="submit"
...
<?php echo $__env->make('layouts/secondary', ['title' => 'Quotation Request', 'subtitle' => $model], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\NEX\miscibles-platform-2.1\src\resources\views/pages/user/quotation-confirm-request.blade.php ENDPATH**/ ?>