<button type="button" id="add-quotation-button" onclick="addQuotationButton()" class="text-white bg-primary hover:bg-green-900 focus:ring-2 focus:ring-gray-200 font-medium rounded-md text-sm px-4 py-2.5 max-h-11 focus:outline-none">
    NEW QUOTATION
</button>
...
<?php endif; ?>
<?php /**PATH C:\miscibles-platform - Copy\miscibles-platform\src\resources\views/pages/admin/quotation/modal-add.blade.php ENDPATH**/ ?>