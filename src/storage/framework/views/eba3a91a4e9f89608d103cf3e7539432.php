...
<div id="popup-modal-update-technical-<?php echo e($key); ?>" class="hidden relative z-40" aria-labelledby="modal-title" role="dialog"
    aria-modal="true">
            ...
            <div
                ...
                <div class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5">
                    <h3 class="text-lg font-semibold text-gray-900">
                        EDIT DATA ID: <?php echo e($technical['KEY']); ?>
                ...
                <!-- Modal body -->
                <form class="p-3 pr-8 overflow-y-auto h-[40vh]" action="<?php echo e(url('admin/update_technical/'.$technical['KEY'])); ?>"
                    ...
                    <div class="grid gap-4 mb-4 sm:grid-cols-2">
                        <div>
                            ...
                            <input type="text" name="name<?php echo e($key); ?>" id="name<?php echo e($key); ?>" value="<?php echo e(old('name'.$key) ?? $technical['TECHNICAL_COMPONENT'] ?? ""); ?>" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-600 focus:border-green-600 block w-full p-2.5" placeholder="Type technical component">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="number" name="energy_used<?php echo e($key); ?>" id="energy_used<?php echo e($key); ?>" value="<?php echo e(old('energy_used'.$key) ?? $technical['ENERGY_CONSUMPTION_PER_DAY'] ?? ""); ?>" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-600 focus:border-green-600 block w-full p-2.5" placeholder="Hr/Day">
                            <?php $__errorArgs = ['energy_used'.$key];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="w-full">
                        ...
                        <input type="text" name="spec<?php echo e($key); ?>" id="spec<?php echo e($key); ?>" value="<?php echo e(old('spec'.$key) ?? $technical['TECHNICAL_SPECIFICATION'] ?? ""); ?>" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-600 focus:border-green-600 block w-full p-2.5" placeholder="Type specification">
                        <?php $__errorArgs = ['spec'.$key];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php endif; ?><?php /**PATH C:\my-project\miscibles-platform-development\src\resources\views/CONTENT_MANAGEMENT_SYSTEM/component/technicalUpdateModal.blade.php ENDPATH**/ ?>