...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.form','data' => ['method' => 'POST','action' => ''.e(config('app.env') == 'production' ? secure_url('enquiry_postData') : url('enquiry_postData')).'','enctype' => 'multipart/form-data']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['method' => 'POST','action' => ''.e(config('app.env') == 'production' ? secure_url('enquiry_postData') : url('enquiry_postData')).'','enctype' => 'multipart/form-data']); ?>
        ...
        <div class="my-2">
            <div>
                <label class="inline-flex items-center ml-6">
                    <input type="radio" id="have_drawing" name="drawing_file" value="yes" <?php echo e(old('drawing_file') == 'yes' ? 'checked' : ''); ?> onclick="fileInput()" class="text-green-600 focus:ring-white">
                    <span class="ml-2">Have</span>
                </label>
            </div>
            <div>
                <label class="inline-flex items-center ml-6">
                    <input type="radio" id="no_drawing" name="drawing_file" value="no" <?php echo e(old('drawing_file') == 'no' ? 'checked' : ''); ?> onclick="fileInput()" class="text-green-600 focus:ring-white">
                    <span class="ml-2">Don't have</span>
                </label>
            </div>
            <div>
                <label class="inline-flex items-center ml-6">
                    <input type="radio" id="otherCheck" name="drawing_file" value="others" <?php echo e(old('drawing_file') == 'others' ? 'checked' : ''); ?> onclick="fileInput()" class="text-green-600 focus:ring-white">
...
<?php endif; ?>
    ...
    <script>
        ...
        // window.addEventListener('load', toggleOptionalInput);
    </script>
    <script>
        function fileInput() {
...
<?php echo $__env->make('MADE_TO_ORDER/layout/defaultLayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\my-project\miscibles-platform-development\src\resources\views/MADE_TO_ORDER/page/enquiry_form.blade.php ENDPATH**/ ?>