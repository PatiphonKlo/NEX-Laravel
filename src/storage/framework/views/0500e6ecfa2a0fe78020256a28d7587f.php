...
<section class="block w-full p-2 bg-primary rounded-md shadow-md">
        ...
        <div class="my-2">
            <div>
                <label class="inline-flex items-center ml-6">
                    <input type="radio" id="have_drawing" name="drawing_file" value="yes" <?php echo e(old('drawing_file') == 'yes' ? 'checked' : ''); ?> onclick="fileInput()" class="text-primary focus:ring-white">
                    <span class="ml-2">Have</span>
                </label>
            </div>
            <div>
                <label class="inline-flex items-center ml-6">
                    <input type="radio" id="no_drawing" name="drawing_file" value="no" <?php echo e(old('drawing_file') == 'no' ? 'checked' : ''); ?> onclick="fileInput()" class="text-primary focus:ring-white">
                    <span class="ml-2">Don't have</span>
                </label>
            </div>
            <div>
                <label class="inline-flex items-center ml-6">
                    <input type="radio" id="otherCheck" name="drawing_file" value="others" <?php echo e(old('drawing_file') == 'others' ? 'checked' : ''); ?> onclick="fileInput()" class="text-primary focus:ring-white">
...
<?php echo $__env->make('layouts/admin', ['title' => 'Enquiry Form'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\miscibles-platform\src\resources\views/pages/user/enquiry.blade.php ENDPATH**/ ?>