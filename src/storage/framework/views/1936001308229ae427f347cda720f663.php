                    ...
                    <div class="grid gap-4 md:grid-cols-4 mb-4">
                        <div class="col-span-2">
                            ...
                            <input accept=".pdf"
                                ...
                                name="spec_sheet_update<?php echo e($key); ?>" type="file">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-span-1">
                            <label for="product_assurance_update<?php echo e($key); ?>"
                                ...
                                (Year)</label>
                            <input type="number"
                                value="<?php echo e(old('product_assurance_update' . $key) ?? $product['product_assurance']); ?>"
...
<?php endif; ?><?php /**PATH C:\Users\patip\NEX\miscibles-platform\src\resources\views/pages/admin/product/modal-update.blade.php ENDPATH**/ ?>