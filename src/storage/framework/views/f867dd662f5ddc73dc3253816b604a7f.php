...
<div class="mt-4 grid grid-cols-3 lg:grid-cols-8 gap-2 sm:gap-3 lg:gap-5">
    ...
    <div id="nav-list" class="grid grid-cols-3 gap-2 sm:gap-3 col-span-3 lg:flex lg:flex-col lg:col-span-2 xl:h-[80vh]">
        ...
        <a href="<?php echo e(url('admin/quotation')); ?>" class="shadow shadow-gray-400 text-xs md:text-sm lg:text-base text-center font-inter font-medium flex items-center justify-center transition hover:bg-primary hover:text-white rounded-md bg-orange-200 border-2 border-primary p-2 lg:h-20">
            <span>
                UPDATE COST
            </span>
        </a>
...
<?php echo $__env->make('layouts/primary',['title' => 'Standard Products'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\patip\NEX\miscibles-platform-2.4\src\resources\views/pages/user/standard-product.blade.php ENDPATH**/ ?>