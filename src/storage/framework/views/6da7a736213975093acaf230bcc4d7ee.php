...
<body>
    <table id="quotaionTable">
        ...
        <tfoot>
            ...
            <tr>
                <th colspan="4" class="bg-grey">Price Validity: (<?php echo e($quotation['product_price_validity'] ?? ''); ?> Days)</th>
                <th colspan="4" class="bg-grey">Delivery Term : (<?php echo e($quotation['product_delivery_term'] ?? ''); ?> Days)</th>
            ...
            <tr>
                ...
                <th colspan="2" class="bg-grey" rowspan="3">Credit <?php echo e($quotation['product_credit_day'] ?? ''); ?> Days</th>
                <th colspan="2" class="bg-grey">TOTAL</th>
                <th colspan="2" class="bg-dark-grey"><?php echo e(number_format($quotation['product_price'] ?? 0)); ?></th>
            </tr>
            <tr>
                <th colspan="2" class="bg-grey"><?php echo e(number_format($quotation['product_down_payment'] ?? 0, 1, '.', '')); ?>%</th>
                <th colspan="2" class="bg-grey"><?php echo e(number_format($quotation['product_final_check'] ?? 0, 1,'.', '')); ?>%</th>
                <th colspan="2" class="bg-grey"><?php echo e(number_format($quotation['product_after_install'] ?? 0, 1, '.', '')); ?>%</th>
                <th colspan="2" class="bg-grey">VAT 7.0%</th>
                <th colspan="2" class="bg-dark-grey"><?php echo e(number_format(($quotation['product_price']?? 0) *0.07)); ?></th>
            </tr>
            <tr>
                <th colspan="2" class="bg-dark-grey"><?php echo e(number_format((($quotation['product_price']?? 0)+(($quotation['product_price']?? 0)*0.07))*(($quotation['product_down_payment']?? 0)/100))); ?></th>
                <th colspan="2" class="bg-dark-grey"><?php echo e(number_format((($quotation['product_price']?? 0)+(($quotation['product_price']?? 0)*0.07))*(($quotation['product_final_check']?? 0)/100))); ?></th>
                <th colspan="2" class="bg-dark-grey"><?php echo e(number_format((($quotation['product_price']?? 0)+(($quotation['product_price']?? 0)*0.07))*(($quotation['product_after_install']?? 0)/100))); ?></th>
                <th colspan="2" class="bg-grey">TOTAL PRICE</th>
                <th colspan="2" class="bg-dark-grey"><?php echo e(number_format(($quotation['product_price']?? 0)+(($quotation['product_price']?? 0)*0.07)-(($quotation['product_price']?? 0)*($quotation['product_discount']?? 0)/100))); ?></th>
            </tr>
            <tr>
...
<?php /**PATH C:\NEX\miscibles-platform-2.1\src\resources\views/pages/admin/quotation/quotation-preview.blade.php ENDPATH**/ ?>