                                    ...
                                    <?php $__currentLoopData = $assemblyParts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li>
                                            <div class="flex items-center p-2 rounded hover:bg-gray-100">
                                                <?php if(isset($product['assembly_part']) && in_array($item['part_id'], $product['assembly_part'])): ?>
                                                    <input id="checkbox-item-<?php echo e($item['part_id']); ?>" type="checkbox"
                                                        name="assembly_part_update<?php echo e($key); ?>[]"
                                                        value="<?php echo e($item['part_id']); ?>"
                                                ...
                                                <?php else: ?>
                                                    <input id="checkbox-item-<?php echo e($item['part_id']); ?>" type="checkbox"
                                                        ...
                                                        value="<?php echo e($item['part_id']); ?>"
                                                        class="w-4 h-4 text-primary bg-gray-100 border-gray-300 rounded focus:ring-primary"
                                                        <?php echo e(old('assembly_part_update' . $key) ? (in_array($item['part_id'], old('assembly_part_update' . $key)) ? 'checked' : '') : ''); ?>>
                                                    <label for="checkbox-item-<?php echo e($item['part_id']); ?>"
                            ...
                            <ul id="technicalUL-<?php echo e($key); ?>"
                                ...
                                <?php if(!empty($technicalData)): ?>
                                    <?php $__currentLoopData = $technicalData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li>
                                            <div class="flex items-center p-2 rounded hover:bg-gray-100">
                                                <?php if(isset($product['technical_data']) && in_array($item[1], $product['technical_data'])): ?>
                                                    <input id="checkbox-item-<?php echo e($item[1]); ?>2" type="checkbox"
                                                        name="technical_data_update<?php echo e($key); ?>[]"
                                                        value="<?php echo e($item[1]); ?>"
                                                        class="w-4 h-4 text-primary bg-gray-100 border-gray-300 rounded focus:ring-primary"
                                                        checked>
                                                ...
                                                <?php else: ?>
                                                    <input id="checkbox-item-<?php echo e($item[1]); ?>2" type="checkbox"
                                                        ...
                                                        value="<?php echo e($item[1]); ?>"
                                                        class="w-4 h-4 text-primary bg-gray-100 border-gray-300 rounded focus:ring-primary"
                                                        <?php echo e(old('technical_data_update' . $key) ? (in_array($item[1], old('technical_data_update' . $key)) ? 'checked' : '') : ''); ?>>
                                                    <label for="checkbox-item-<?php echo e($item[1]); ?>2"
                                                        class="w-full ml-2 text-sm font-medium text-gray-900 rounded"><?php echo e($item[0]['technical_component']); ?>:
                                                        <?php echo e($item[0]['specification']); ?></label>
                                                <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-span-1">
                            ...
                            <input type="number"
                                ...
                                name="product_down_payment_update<?php echo e($key); ?>"
                                id="product_down_payment_update"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary focus:border-primary block w-full p-2.5"
                                placeholder="ex . 25">
...
<?php endif; ?>
<?php /**PATH C:\NEX\miscibles-platform-2.1\src\resources\views/pages/admin/product/modal-update.blade.php ENDPATH**/ ?>