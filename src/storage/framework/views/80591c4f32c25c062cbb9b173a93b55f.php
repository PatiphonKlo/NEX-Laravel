...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.link','data' => ['href' => ''.e(url('standard-product')).'','class' => 'flex items-center justify-center shadow-md transition hover:bg-primary hover:text-white h-full md:h-40 font-bold w-full rounded-[100px] bg-secondary border-[3px] border-primary text-sm md:text-lg lg:text-xl px-16 py-10 lg:p-16']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['href' => ''.e(url('standard-product')).'','class' => 'flex items-center justify-center shadow-md transition hover:bg-primary hover:text-white h-full md:h-40 font-bold w-full rounded-[100px] bg-secondary border-[3px] border-primary text-sm md:text-lg lg:text-xl px-16 py-10 lg:p-16']); ?>
                    STANDARD PRODUCTS
...
<?php endif; ?>
                <?php if (isset($component)) { $__componentOriginal90eee3f94ef0e1b15e49c277c8700e9b = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal90eee3f94ef0e1b15e49c277c8700e9b = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.link','data' => ['href' => ''.e(url('enquiry-form')).'','class' => 'flex items-center justify-center shadow-md transition hover:bg-primary hover:text-white h-full md:h-40 font-bold w-full rounded-[100px] bg-secondary border-[3px] border-primary text-sm md:text-lg lg:text-xl px-16 py-10 lg:p-16']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('link'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => ''.e(url('enquiry-form')).'','class' => 'flex items-center justify-center shadow-md transition hover:bg-primary hover:text-white h-full md:h-40 font-bold w-full rounded-[100px] bg-secondary border-[3px] border-primary text-sm md:text-lg lg:text-xl px-16 py-10 lg:p-16']); ?>
                    MADE TO ORDER
                 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal90eee3f94ef0e1b15e49c277c8700e9b)): ?>
...
<?php endif; ?>
                <?php if (isset($component)) { $__componentOriginal90eee3f94ef0e1b15e49c277c8700e9b = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal90eee3f94ef0e1b15e49c277c8700e9b = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.link','data' => ['href' => '#','class' => 'cursor-not-allowed flex items-center justify-center shadow-md transition hover:bg-primary hover:text-white h-full md:h-40 font-bold w-full rounded-[100px] bg-secondary border-[3px] border-primary text-sm md:text-lg lg:text-xl px-16 py-10 lg:p-16']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('link'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => '#','class' => 'cursor-not-allowed flex items-center justify-center shadow-md transition hover:bg-primary hover:text-white h-full md:h-40 font-bold w-full rounded-[100px] bg-secondary border-[3px] border-primary text-sm md:text-lg lg:text-xl px-16 py-10 lg:p-16']); ?>
                    Ai RECOMMENDATION
                 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal90eee3f94ef0e1b15e49c277c8700e9b)): ?>
...
<?php endif; ?>
    ...
    <div class="fixed top-0 right-0 p-1 sm:p-4 flex items-center justify-center gap-4">
        ...
        <div
            class="mx-auto flex items-center justify-center h-12 w-12 rounded-full <?php echo e($authenticated ? ' bg-green-100' : 'bg-red-300'); ?>">
            <?php if($authenticated): ?>
                <button id="logoutButton" class="flex flex-col justify-center items-center">
                    ...
                    <span class="uppercase relative font-semibold text-[10px]"><?php echo e($role ?? ''); ?></span>
                </button>
                <div id="logoutModal" class="hidden">
                    <?php echo $__env->make('pages/authentication/modal-logout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
            <?php else: ?>
                <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px"
                    fill="#000000">
...
<?php echo $__env->make('layouts/blank', ['title' => 'Home'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\patip\NEX\miscibles-platform-2.4\src\resources\views/pages/user/home.blade.php ENDPATH**/ ?>