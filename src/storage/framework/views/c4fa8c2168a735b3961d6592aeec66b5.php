        ...
        <div class="flex flex-row">
            <div class="items-center mb-0 mr-4">
                <div class="relative w-48 lg:w-64 xl:w-96 flex justify-end items-center">
                    <input type="text" onkeyup="EnquirySearch()" id="enquiry-search" class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary focus:border-primary p-2.5" placeholder="Enquiry Search">
            ...
            <a href="<?php echo e(url('admin/made-to-order')); ?>">
                <button class="uppercase text-white bg-primary hover:bg-green-900 font-medium rounded-md text-sm px-4 py-2.5 max-h-11 focus:outline-none">
                    New Enquiry Form
                </button>
            </a>
        </div>
    ...
    <tbody id="enquiry-table-body" class="bg-white divide-y divide-gray-200">
        ...
        <tr class="hover:bg-gray-100 ">
            ...
            <td class="p-4 flex space-x-2">
                ...
                <div class="w-24">
                    <?php echo $__env->make('pages/admin/enquiry/modal-share', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
                <div class="w-24">
                    <a href="<?php echo e(url('admin/enquiry-edit/'.$enquiry['enquiry_id'])); ?>" class="uppercase w-full inline-flex items-center px-3 py-2 text-xs font-medium text-center text-white bg-yellow-500 rounded-lg hover:bg-yellow-500">
...
<?php echo $__env->make('layouts/admin', ['title' => 'Enquiry Form CMS'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\my-project\miscibles-platform\src\resources\views/pages/admin/enquiry/cms.blade.php ENDPATH**/ ?>