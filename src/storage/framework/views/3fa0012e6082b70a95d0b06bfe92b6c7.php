    ...
    <table id="quotaionTable">
        ...
        <tbody>
            <tr>
                ...
                <td colspan="6" class="dashed-right left"><?php echo e($quotation['group_name'] ?? ''); ?></td>
                <td colspan="1" class="dashed-right"></td>
            ...
            <tr>
                ...
                <td colspan="6" class="dashed-right left"> Product Model: <?php echo e($quotation['product_data']['product_model'] ?? ''); ?>

                </td>
                <td colspan="1" class="dashed-right">1.0</td>
                <td colspan="2" class="dashed-right"><?php echo e(number_format($quotation['product_price'] ?? 0)); ?></td>
                <td colspan="2" class="dashed-right"><?php echo e(number_format($quotation['product_price'] ?? 0)); ?></td>
            </tr>
            ...
            <?php if(isset($quotation['product_data']['technical_data'])): ?>
                <?php $__currentLoopData = $quotation['product_data']['technical_data']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="dashed">
                        <td colspan="1" class="dashed-right"></td>
                        <td colspan="6" class="dashed-right left"><?php echo e($item['technical_component'] ?? ''); ?>

                            <?php echo e($item['specification'] ?? ''); ?></td>
                        <td colspan="1" class="dashed-right"></td>
                        <td colspan="2" class="dashed-right"></td>
                        <td colspan="2" class="dashed-right"></td>
                    </tr>
                ...
                <tr>
                    ...
                    <td colspan="2" class="dashed-right">
                        <?php echo e(number_format($quotation['product_data']['product_logistic_cost'] ?? 0)); ?>
            ...
            <tr class="dashed">
                ...
                <td colspan="9" class="dashed-right"> **หมายเหตุ** (บริษัท มิสซิเบิล เทคโนโลยี จำกัด
                    มีระยะเวลารับประกันสินค้า <?php echo e($quotation['product_data']['product_assurance'] ?? ''); ?> ปี )</td>
                <td colspan="2" class="dashed-right"></td>
            </tr>
        </tbody>
        <tfoot>
            ...
            <tr>
                <th colspan="4" class="bg-grey">Price Validity: (<?php echo e($quotation['product_price_validity'] ?? ''); ?>

                    Days)</th>
                <th colspan="4" class="bg-grey">Delivery Term : (<?php echo e($quotation['product_delivery_term'] ?? ''); ?>

                    Days)</th>
                <th colspan="2" class="bg-grey">DISCOUNT</th>
                <th colspan="2"><?php echo e(number_format($quotation['product_discount'] ?? 0, 1, '.', '')); ?> %</th>
            </tr>
            <tr>
                ...
                <th colspan="2" class="bg-dark-grey"><?php echo e(number_format(($quotation['product_price'] ?? 0) + ($quotation['product_data']['product_logistic_cost'] ?? 0))); ?></th>
            </tr>
            <tr>
                ...
                <th colspan="2" class="bg-dark-grey">
                    <?php echo e(number_format((($quotation['product_price'] ?? 0) + ($quotation['product_data']['product_logistic_cost'] ?? 0)) * 0.07)); ?>
            ...
            <tr>
                ...
                <th colspan="2" class="bg-dark-grey">
                    <?php echo e(number_format(
                        ($quotation['product_price'] ?? 0) + ($quotation['product_data']['product_logistic_cost'] ?? 0) 
                        + ((($quotation['product_price'] ?? 0)+ ($quotation['product_data']['product_logistic_cost'] ?? 0)) * 0.07) 
                        - ((($quotation['product_price'] ?? 0) + ($quotation['product_data']['product_logistic_cost'] ?? 0)) * ($quotation['product_discount'] ?? 0)) / 100
                    )); ?>
            ...
            <tr>
                <th colspan="4" rowspan="4">
                    <div class="flex-container">
                        <div class="flex-row">
                            <img src="<?php echo e(asset('images/image003.png')); ?>" width="45" height="30"
                                style="margin: 7px;">
                            <img src="<?php echo e(asset('images/image004.png')); ?>" width="45" height="30"
                                style="margin: 7px;">
                            <img src="<?php echo e(asset('images/image005.png')); ?>" width="45" height="30"
                                style="margin: 7px;">
                        </div>
                        <div class="flex-row">
                            <img src="<?php echo e(asset('images/image006.png')); ?>" width="45" height="25"
                                style="margin: 7px;">
                            <img src="<?php echo e(asset('images/image007.png')); ?>" width="45" height="30"
                                style="margin: 7px;">
                            <img src="<?php echo e(asset('images/image008.png')); ?>" width="45" height="25"
                                style="margin: 7px;">
                        </div>
                    </div>
                </th>
                ...
                <th colspan="4" height="80">
                    <div class="flex-container">
                        <img src="<?php echo e($quotation['signature']); ?>" alt="">
                    </div>
                </th>
            </tr>
            <tr>
...
<?php /**PATH C:\Users\patip\NEX\miscibles-platform\src\resources\views/pages/admin/quotation/quotation-preview.blade.php ENDPATH**/ ?>