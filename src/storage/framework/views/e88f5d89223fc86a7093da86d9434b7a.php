    ...
    <tbody id="technical-table-body" class="bg-white divide-y divide-gray-200">
        ...
        <tr class="hover:bg-gray-100 ">
            ...
            <td class="p-4 text-sm font-medium text-gray-900 whitespace-nowrap">
                ...
                <p class="text-xxs font-normal"><?php echo e($technical['specification']); ?></p>
            </td>
            <?php else: ?>
...
<?php echo $__env->make('layouts/admin',['title' => 'Technical Data CMS'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\patip\NEX\miscibles-platform\src\resources\views/pages/admin/technical-data/cms.blade.php ENDPATH**/ ?>