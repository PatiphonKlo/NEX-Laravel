...
<div class="my-2">
    ...
    <div>
        <label class="inline-flex items-center ml-6">
            <input type="radio" id="<?php echo e($option['id']); ?>" name="<?php echo e($name); ?>" value="<?php echo e($option['value']); ?>" class="text-green-600 focus:ring-white" onclick="toggleOptionalInput('<?php echo e($name); ?>', '<?php echo e($otherInputName); ?>')" <?php echo e($data == $option['value'] ? 'checked': ''); ?>>
    ...
    <div>
        <label class="inline-flex items-center ml-6">
            <input type="radio" id="<?php echo e($option['id']); ?>" name="<?php echo e($name); ?>" value="<?php echo e($option['value']); ?>" class="text-green-600 focus:ring-white" onclick="toggleOptionalInput('<?php echo e($name); ?>', '<?php echo e($otherInputName); ?>')" <?php echo e($isCheckedOther ? 'checked' : ''); ?>>
            <span class="ml-2"><?php echo e($option['label']); ?></span>
        </label>
    </div>
    <?php endif; ?>
...
<?php /**PATH C:\my-project\miscibles-platform-development\src\resources\views/components/radio-input-edit.blade.php ENDPATH**/ ?>