                        ...
                        <?php if(isset($product['image_url']) && !empty($product['image_url'])): ?>
                            <td
                                ...
                                <?php $__currentLoopData = $product['image_url']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <img class="object-contain w-10 h-12" src="<?php echo e($url); ?>" alt="NA">
...
<?php echo $__env->make('layouts/admin', ['title' => 'Product CMS'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\NEX\miscibles-platform-2.2\src\resources\views/pages/admin/product/cms.blade.php ENDPATH**/ ?>