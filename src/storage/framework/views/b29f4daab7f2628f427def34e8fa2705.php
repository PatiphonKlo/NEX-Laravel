        ...
        <?php $__empty_1 = true; $__currentLoopData = $assemblyData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="flex flex-col text-xxs md:text-xs">
                <div
                    ...
                    <img class="p-4 contrast-125 object-scale-down max-h-52" src="<?php echo e($item['part_image']); ?>" alt="" onerror="this.onerror=null; this.src='<?php echo e(asset('images/no-image.png')); ?>';">
                </div>
...
<?php echo $__env->make('layouts/secondary', ['title' => 'Assembly Parts', 'subtitle' => $model], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\NEX\miscibles-platform\src\resources\views/pages/user/assembly-part.blade.php ENDPATH**/ ?>