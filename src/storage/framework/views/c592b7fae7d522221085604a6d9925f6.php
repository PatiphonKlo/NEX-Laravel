...
<button id="enquiry" data-modal-target="popup-modal-mail<?php echo e($enquiry['enquiry_id']); ?>" data-modal-toggle="popup-modal-mail<?php echo e($enquiry['enquiry_id']); ?>" type="button" class="uppercase w-full inline-flex items-center px-3 py-2 text-xs font-medium text-center text-white bg-green-600 rounded-lg hover:bg-green-900 focus:ring-2 focus:ring-green-300">
...
<?php endif; ?><?php /**PATH C:\miscibles-platform\src\resources\views/pages/admin/enquiry/modal-send.blade.php ENDPATH**/ ?>