        ...
        <div id="overlay" class="flex min-h-full justify-center p-4 text-center items-center sm:p-0">
            <div
                ...
                <form class="p-3 pr-8 overflow-y-auto h-[70vh]"
                    action="<?php echo e(config('app.env') == 'production' ? secure_url('admin/add-product') : url('admin/add-product')); ?>"
                    ...
                    <div class="grid gap-4 mb-4 sm:grid-cols-4">
                        <div class="col-span-2">
                            <label for="product_name" class="block mb-2 text-sm font-medium text-gray-900">Product
                                Name</label>
                            <input type="text" name="product_name" value="<?php echo e(old('product_name')); ?>"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" name="product_model" value="<?php echo e(old('product_model')); ?>"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary focus:border-primary block w-full p-2.5"
                                placeholder="ex . HSD-2200">
                                ...
                                <li>
                                    <div class="flex items-center p-2 rounded hover:bg-gray-100">
                                        <input id="checkbox-item-<?php echo e($item['part_id']); ?>" type="checkbox"
                                            name="assembly_part[]" value="<?php echo e($item['part_id']); ?>"
                                            class="w-4 h-4 text-primary bg-gray-100 border-gray-300 rounded focus:ring-primary"
                                            <?php echo e(old('assembly_part') ? (in_array($item['part_id'], old('assembly_part'))
                                            ? 'checked' : '' ) : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div id="dropdownSearch2" class="z-10 hidden bg-gray-200 rounded-lg shadow w-80">
                            ...
                            <ul id="technicalUL"
                                ...
                                <li>
                                    <div class="flex items-center p-2 rounded hover:bg-gray-100">
                                        <input id="checkbox-item-<?php echo e($item[1]); ?>" type="checkbox" name="technical_data[]"
                                            value="<?php echo e($item[1]); ?>"
                                            class="w-4 h-4 text-primary bg-gray-100 border-gray-300 rounded focus:ring-primary"
                                            <?php echo e(old('technical_data') ? (in_array($item[1], old('technical_data'))
                                            ? 'checked' : '' ) : ''); ?>>
                                        <label for="checkbox-item-<?php echo e($item[1]); ?>"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            <label for="product_delivery_term"
                                ...
                                Term</label>
                            <input type="number" name="product_delivery_term" value="<?php echo e(old('product_delivery_term')); ?>"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary focus:border-primary block w-full p-2.5"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-span-1">
                            <label for="product_assurance"
                                ...
                                Year</label>
                            <input type="number" name="product_assurance" value="<?php echo e(old('product_assurance')); ?>"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary focus:border-primary block w-full p-2.5"
                                placeholder="ex . 1">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-span-1">
                            <label for="product_down_payment" class="block mb-2 text-sm font-medium text-gray-900">Down
                                Payment
                                (%)</label>
                            <input type="number" name="product_down_payment" value="<?php echo e(old('product_down_payment')); ?>"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary focus:border-primary block w-full p-2.5"
                                placeholder="ex . 25">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-span-1">
                            <label for="product_after_install"
                                ...
                                Install (%)</label>
                            <input type="number" name="product_after_install" value="<?php echo e(old('product_after_install')); ?>"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary focus:border-primary block w-full p-2.5"
                                placeholder="ex . 40">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-span-1">
                            <label for="product_final_check" class="block mb-2 text-sm font-medium text-gray-900">Final
                                Check
                                (%)</label>
                            <input type="number" name="product_final_check" value="<?php echo e(old('product_final_check')); ?>"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary focus:border-primary block w-full p-2.5"
                                placeholder="ex . 35">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            <label class="block mb-2 text-sm font-medium text-gray-900" for="front">Front
                                Image</label>
                            <input image-file="2" required accept=".jpg"
                                class="ratio-3-4 block w-full text-xs text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 focus:outline-none"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            <label class="block mb-2 text-sm font-medium text-gray-900" for="side">Side
                                Image</label>
                            <input image-file="3" required accept=".jpg"
                                class="ratio-3-4 block w-full text-xs text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 focus:outline-none"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            <label class="block mb-2 text-sm font-medium text-gray-900" for="top">Top
                                Image</label>
                            <input image-file="4" required accept=".jpg"
...
<script>
    const fileInput = document.querySelectorAll('input[type="file"].ratio-3-4');
    const fileInput2 = document.querySelector('input[type="file"].ratio-4-3');
    ...
    const maxHeight = 1600; // Maximum height in pixels
    ...
    fileInfo.forEach(fileInfo => {
        fileInfo.innerText = `Maximum w:h : ${maxWidth}px:${maxHeight}px (3:4 ratio)`;
    });

    const maxWidth2 = 1600; // Maximum width in pixels
    const maxHeight2 = 1200; // Maximum height in pixels
    fileInfo2.innerText = `Maximum w:h : ${maxWidth2}px:${maxHeight2}px (4:3 ratio)`;
    ...
    function imagePreview(input) {
        ...
        if (input.files) {
            ...
            img.onload = function() {
                ...
                if (this.width > maxWidth || this.height > maxHeight) { // Check for maximum dimensions (optional)
                    error.innerHTML = `Image dimensions are too large. Maximum width: ${maxWidth}px, Maximum height: ${maxHeight}px`;
                    // Option 1: Clear file input value
                    input.value = '';
                    // Option 2: Disable submit button (if applicable)
                    ...
                    return false;
                } else if (Math.abs(actualAspectRatio - desiredAspectRatio) > 0.1) { // Check for aspect ratio tolerance (0.1 allows for slight variations)
                    error.innerHTML = 'Image aspect ratio is incorrect. Expected: 3:4';
                    // Option 1: Clear file input value
                    input.value = '';
                    // Option 2: Disable submit button (if applicable)
                    document.getElementById("submitButton").disabled = true;
                ...
                // Display file info and potentially preview (existing code)
                let fileInfo = `
            <ul>
              <li> File size: <span>${(file.size)/1000000} MB</span>  </li>
    ...
    function imagePreview2(input) {
        ...
        if (input.files) {
            ...
            img.onload = function() {
                ...
                if (this.width > maxWidth2 || this.height > maxHeight) { // Check for maximum dimensions (optional)
                    error.innerHTML = `Image dimensions are too large. Maximum width: ${maxWidth2}px, Maximum height: ${maxHeight2}px`;
                    // Option 1: Clear file input value
                    input.value = '';
                    // Option 2: Disable submit button (if applicable)
                    document.getElementById("submitButton").disabled = true;
                    ...
                    error.innerHTML = 'Image aspect ratio is incorrect. Expected: 4:3';
                    // Option 1: Clear file input value
                    input.value = '';
                    // Option 2: Disable submit button (if applicable)
                    document.getElementById("submitButton").disabled = true;
...
<?php endif; ?><?php /**PATH C:\my-project\miscibles-platform\src\resources\views/pages/admin/product/modal-add.blade.php ENDPATH**/ ?>