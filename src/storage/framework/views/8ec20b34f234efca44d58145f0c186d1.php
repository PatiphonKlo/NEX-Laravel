<?php if(isset($quotation['product_data']) && isset($quotation['client_data'])): ?>
    <button type="button" id="send-quotation-button-<?php echo e($key); ?>"
        ...
        <svg class="w-3 h-3 mr-2 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
            viewBox="0 0 16 16">
            ...
            <div id="overlay-send-quotation-<?php echo e($key); ?>"
                ...
                <div
                    ...
                    <form
                        ...
                        method="POST" class="flex flex-col p-3 pr-4 h-[40vh] overflow-y-auto"
...
<?php /**PATH C:\miscibles-platform\src\resources\views/pages/admin/quotation/modal-send.blade.php ENDPATH**/ ?>