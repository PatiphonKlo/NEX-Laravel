...
<?php $__env->startSection('content'); ?>
    <a href="<?php echo e(route('enquiry.view')); ?>" class="bg-primary uppercase text-white px-4 py-2 rounded-md font-semibold">
        Back
    </a>
    ...
    <form method="POST"
        action="<?php echo e(config('app.env') == 'production' ? secure('admin/enquiry-update/' . $enquiryData['enquiry_id']) : url('admin/enquiry-update/' . $enquiryData['enquiry_id'])); ?>"
                        ...
                        <div>
                            <label class="inline-flex items-center ml-6">
                                <input type="radio" id="have_drawing" name="drawing_file" value="yes"
                                    <?php echo e(old('drawing_file', $enquiryData['drawing file']) == 'yes' ? 'checked' : ''); ?>

                                    onclick="fileInput()" class="text-primary focus:ring-white">
                        ...
                        <div>
                            <label class="inline-flex items-center ml-6">
                                <input type="radio" id="no_drawing" name="drawing_file" value="no"
                                    <?php echo e(old('drawing_file', $enquiryData['drawing file']) == 'no' ? 'checked' : ''); ?>
                        ...
                        <div>
                            <label class="inline-flex items-center ml-6">
                                <input type="radio" id="otherCheck" name="drawing_file" value="others"
                                    <?php echo e(old('drawing_file', $enquiryData['drawing file']) == 'others' ? 'checked' : ''); ?>
...
<?php echo $__env->make('layouts/admin', ['title' => 'Enquiry Form'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\miscibles-platform\src\resources\views/pages/admin/enquiry/edit.blade.php ENDPATH**/ ?>