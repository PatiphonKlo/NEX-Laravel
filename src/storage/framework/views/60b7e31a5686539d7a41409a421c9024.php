<button id="open-sidebar" type="button" class="inline-flex flex-col items-center p-2 text-sm text-black lg:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200">
...
<aside id="sidebar" class="fixed top-0 left-0 z-20 w-56 h-screen transition-transform lg:translate-x-0 transform -translate-x-full">
    <div class="p-2 flex justify-center items-center bg-gray-50">
        <a href="<?php echo e(url('/')); ?>">
            <img class="w-32 m-2" src="/svg/NEX-logo.svg" alt="Logo">
        </a>
    </div>
    <button id="close-sidebar" type="button" class="hidden fixed top-0 left-full items-center p-2 text-sm text-gray-500 lg:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 bg-gray-50">
        ...
        <ul class=" font-medium divide-y">
            <li>
                ...
                <ul id="dropdown-1" class="hidden py-2 space-y-2 ml-4">
                    ...
                    <li>
                        <a href="<?php echo e(url('admin/cost-estimation')); ?>" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100  group">
            ...
            <li>
                ...
                <ul id="dropdown-2" class="hidden py-2 space-y-2 ml-4">
                    <li>
                        <a href="<?php echo e(url('admin/assembly-part')); ?>" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100  group">
                            <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <li>
                        <a href="<?php echo e(url('admin/technical-data')); ?>" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100  group">
                            <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
            ...
            <li>
                <a href="<?php echo e(url('admin/quotation')); ?>" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
                    ...
                    <span class="flex-1 ml-2 whitespace-nowrap">All Quotations</span>
                </a>
            </li>
            <li>
                <button type="button" class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100" aria-controls="dropdown-4" data-collapse-toggle="dropdown-4">
                ...
                <ul id="dropdown-4" class="hidden py-2 space-y-2 ml-4">
                    <li>
                        <a href="<?php echo e(url('admin/enquiry')); ?>" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100  group">
                    ...
                    <li>
                        <a href="<?php echo e(url('admin/made-to-order')); ?>" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100  group">
...
<?php /**PATH C:\my-project\miscibles-platform\src\resources\views/layouts/shared/sidebar.blade.php ENDPATH**/ ?>