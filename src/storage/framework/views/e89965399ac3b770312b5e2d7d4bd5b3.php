            ...
            <?php if(isset($productData)): ?>
                <?php $__currentLoopData = $productData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="hover:bg-gray-100 ">
                        ...
                        <?php if(isset($product['image_url']) && !empty($product['image_url'])): ?>
                            <td
                                ...
                                <?php $__currentLoopData = $product['image_url']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <img class="object-contain w-10 h-12" src="<?php echo e($url); ?>" alt="" onerror="this.onerror=null; this.src='<?php echo e(asset('images/no-image.png')); ?>';">
                        ...
                        <?php if(isset($product['edited_by']) &&
                                $product['edited_by'] !== '' &&
                        ...
                        <td class="p-4 flex flex-col xl:flex-row space-y-2 xl:space-y-0 xl:space-x-2">
                            <div class="w-36 xl:w-32">
                                <?php echo $__env->make('pages/admin/product/spec/modal-view', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            </div>
                            <div class="w-36">
...
<?php echo $__env->make('layouts/admin', ['title' => 'Product CMS'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\patip\NEX\miscibles-platform-2.4\src\resources\views/pages/admin/product/cms.blade.php ENDPATH**/ ?>