...
<div class="flex flex-col lg:grid grid-cols-2 pt-[2vh] gap-5">
    ...
    <div class="col-span-1 flex flex-col">
        <div class="shadow shadow-gray-400 border-2 border-green-600 h-[80vh] rounded-md">
            <img class="contrast-125 object-scale-down h-full mx-auto p-6" src="<?php echo e($imageURL); ?>">
        </div>
...
<?php echo $__env->make('layouts/secondary',[ 'title' => 'Quotation Request', 'subtitle' => $model], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\miscibles-platform\src\resources\views/pages/user/quotation-request.blade.php ENDPATH**/ ?>