...
<div id="popup-modal-update-quotation-<?php echo e($key); ?>" class="hidden relative z-30">
    ...
    <div class="fixed inset-0 z-10 w-screen">
        <div id="overlay-update-quotation-<?php echo e($key); ?>" class="flex min-h-full justify-center p-4 text-center items-center sm:p-0">
            <div class="p-5 relative transform rounded-lg bg-white text-left shadow-xl transition-all max-w-full lg:max-w-6xl">
                ...
                <div class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5">
                    ...
                    <button type="button" id="update-quotation-close-button-<?php echo e($key); ?>" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center">
...
<?php /**PATH C:\my-project\miscibles-platform\src\resources\views/pages/admin/quotation/modal-update.blade.php ENDPATH**/ ?>