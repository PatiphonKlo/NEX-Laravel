<button type="button" id="add-quotation-button" onclick="addQuotationButton()" class="text-white bg-green-600 hover:bg-green-900 focus:ring-2 focus:ring-gray-200 font-medium rounded-md text-sm px-4 py-2.5 max-h-11 focus:outline-none">
    NEW QUOTATION
</button>

<div id="popup-modal-add-quotation" class="hidden relative z-50" aria-labelledby="modal-title" role="dialog" aria-modal="true">
    ...
    <div class="fixed inset-0 z-10 w-screen">
        <div id="overlay" class="flex min-h-full justify-center p-4 text-center items-center sm:p-0">
            <div class="p-5 relative transform rounded-lg bg-white text-left shadow-xl transition-all w-full sm:max-w-xl md:max-w-2xl lg:max-w-4xl">
                ...
                <!-- Modal body -->
                <form class="p-3 pr-8 overflow-y-auto h-[40vh]" action="<?php echo e(url('admin/add_quotation')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="grid gap-4 mb-4 sm:grid-cols-2">
                        <div>
                            <label for="name" class="block mb-2 text-sm font-medium text-gray-900">quotation Name</label>
                            <input type="text" name="name" id="name" value="<?php echo e(old('name') ?? ""); ?>" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-600 focus:border-green-600 block w-full p-2.5" placeholder="Type quotation component">
...
<?php endif; ?>
<?php /**PATH C:\my-project\miscibles-platform-development\src\resources\views/CONTENT_MANAGEMENT_SYSTEM/component/quotationAddModal.blade.php ENDPATH**/ ?>