<div class="px-6 py-8 max-w-2xl mx-auto">
    ...
    <table class="w-full mb-8">
        ...
        <tbody>
            ...
            <tr>
                <td class="text-left"><?php echo e($item['TECHNICAL_COMPONENT']); ?> : <?php echo e($item['TECHNICAL_SPECIFICATION']); ?></td>
            </tr>
...
<?php /**PATH C:\my-project\miscibles-platform\src\resources\views/STANDARD_PRODUCTS/component/preQuotation.blade.php ENDPATH**/ ?>