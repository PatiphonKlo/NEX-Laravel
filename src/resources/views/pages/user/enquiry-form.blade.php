@extends('layouts/secondary', ['title' => 'Made To Order', 'subtitle' => 'Enquiry Form'])
    ...
    <section class="bg-gray-50 rounded-md mt-8 shadow-md">
        ...
        <div class="grid grid-cols-2 gap-4 p-6">
            ...
            <div class="col-span-2">
                ...
                <x-input id="mixing_reaction" type="text" name="mixing_reaction" value="{{ old('mixing_reaction') }}"
    ...
    <section class="bg-gray-50 rounded-md mt-8 shadow-md">
        ...
        <div class="grid grid-cols-2 gap-4 p-6">
            <div class="col-span-2 md:col-span-1">
                ...
                <x-input id="max_viscosity" type="number" name="max_viscosity" value="{{ old('max_viscosity') }}" />
            </div>
            <div class="col-span-2 md:col-span-1">
