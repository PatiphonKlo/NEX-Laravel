    ...
    <div class="fixed inset-0 z-10 w-screen">
        <div id="overlay" class="flex min-h-full justify-center p-4 text-center items-center sm:p-0">
            <div class="p-5 relative transform rounded-lg bg-white text-left shadow-xl transition-all w-full sm:max-w-xl md:max-w-2xl lg:max-w-4xl">
                ...
                <!-- Modal body -->
                <form class="p-3 pr-8 overflow-y-auto h-[50vh]" action="{{ config('app.env') == 'production' ? secure_url('admin/add-client') : url('admin/add-client')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="grid sm:grid-cols-2 gap-4 mb-4">
                        <div class="col-span-2">
                            <label for="client_contact_name" class="block mb-2 font-medium text-gray-900">Name</label>
                            <input type="text" name="client_contact_name" value="{{ old('client_contact_name') }}" class=" border border-gray-300 bg-gray-50 text-sm rounded-lg focus:ring-primary focus:border-primary block w-full p-2.5" placeholder="Type First Name">
                    ...
                    <div class="grid sm:grid-cols-2 gap-4 mb-4">
                        <div>
                            ...
                            <input type="text" name="client_phone_number" value="{{ old('client_phone_number') }}" class=" border border-gray-300 bg-gray-50 text-sm rounded-lg focus:ring-primary focus:border-primary block w-full p-2.5" placeholder="012-345-6789">
                        ...
                        <div>
                            ...
                            <input type="text" name="client_company" value="{{ old('client_company') }}" class=" border border-gray-300 bg-gray-50 text-sm rounded-lg focus:ring-primary focus:border-primary block w-full p-2.5" placeholder="Type Company">
                    ...
                    <div class="grid sm:grid-cols-2 gap-4 mb-4">
                        <div>
                            ...
                            <input type="text" name="client_email" value="{{ old('client_email') }}" class=" border border-gray-300 bg-gray-50 text-sm rounded-lg focus:ring-primary focus:border-primary block w-full p-2.5" placeholder="Type Email">
                            @error('client_email')
                            <p class="mt-2 text-sm text-red-600 whitespace-normal">{{$message}}</p>
                            @enderror
                        </div>
