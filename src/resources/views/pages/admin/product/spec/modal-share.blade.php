<button type="button" id="share-product-button-{{ $key }}" onclick="shareProductButton{{ $key }}()"
                ...
                <div class="p-3 pr-8 overflow-y-auto h-[50vh]">
                    ...
                    <div class="relative flex justify-end items-center mb-4">
                        <a data-copy-target='copiedLink{{ $key }}'
                            href="{{ url('pdf-access/spec/' . $product['product_id']) }}" target="_blank"
                            ...
                            {{ url('pdf-access/spec/' . $product['product_id']) }}
                        </a>
                    ...
                    <div class="relative flex justify-end items-center">
                        <input disabled value="{{ $product['spec_password'] ?? '' }}" type="text"
...
<script>
    function shareProductButton{{ $key }}() {
